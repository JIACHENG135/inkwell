<p align="right"><a href="./INSTALL.zh-CN.md">简体中文</a></p>

# Installing inkwell

Everything you need to get `rm-agent` running on your tablet. For what it
does and why, see the [README](./README.md) or the
[product page](https://jiacheng135.github.io/inkwell/).
